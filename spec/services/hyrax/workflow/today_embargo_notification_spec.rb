...
RSpec.describe Hyrax::Workflow::TodayEmbargoNotification do
  before :all do
  ...
  let(:etd) { FactoryBot.create(:seven_day_expiration, depositor: user.user_key, school: ["Candler School of Theology"]) }
