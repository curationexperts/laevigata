...
RSpec.describe Hyrax::Workflow::SixtyDayEmbargoNotification do
  before :all do
  ...
  let(:etd) { FactoryGirl.create(:sixty_day_expiration, depositor: user.user_key, school: ["Candler School of Theology"]) }
